...
if (is(study, i, '"Registered at Other Registry"') && !is(study, ++i, '"Name of Registry/ Registration Number"'))
finalRecord['registered_at_other_registry'] = cleanLine(study, i++);

if (is(study, i, '"Name of Registry/ Registration Number"') && !is(study, ++i, '"Healthcare Benefit Approval Status"'))
finalRecord['Secondary_Id'] = cleanLine(study, i++);
...
if (is(study, i, '"- Project ID"') &&   !(is(study, ++i, '"Sponsor Organization 1')
    ||  is(study, i, '"Source of Monetary/Material Support'))) {
        temp['ProjectId'] = cleanLine(study, i++);
...
if  (is(study, i++, '"Interventional Study"') ) {
...
if (is(study, i, '"Blinding/Masking"') && !is(study, ++i, '"Blinded Subject"'))
finalRecord['blinding_or_masking'] = cleanLine(study, i++);
if (is(study, i, '"Blinded Subject"') && !is(study, ++i, '"Allocation"'))
finalRecord['BlindedSubject'] = cleanLine(study, i++);
...
{
if (is(study, i, '"Observational Study Model"') && !is(study, ++i, '"Time Perspective"'))
finalRecord['Observational_Study_Model'] = cleanLine(study, i++);
if (is(study, i, '"Time Perspective"') && !is(study, ++i, '"Target Number of Participant"'))
finalRecord['TimePerspective'] = cleanLine(study, i++);
if (is(study, i, '"Target Number of Participant"') && !is(study, ++i, '"Cohort/Group Number"'))
finalRecord['TargetNumberOfParticipant'] = cleanLine(study, i++);
if (is(study, i, '"Cohort/Group Number"') && !is(study, ++i, '"Cohort/ Group 1"'))
...
temp['Cohort_label'] = cleanLine(study, i++);
if (is(study, i, '"Group Description"') && !(is(study, ++i, '"Biospecimen Collection')
                        || is(study, i, '"Cohort/ Group')) ) {
...
if (is(study, i, '"Biospecimen Collection') && !is(study, ++i, '"Biospecimen Description"'))
finalRecord['BiospecimenCollection'] = cleanLine(study, i++);

if (is(study, i, '"Biospecimen Description"') && !is(study, ++i, '"Study Population Description"'))
finalRecord['BiospecimenDescription'] = cleanLine(study, i++);

if (is(study, i, '"Study Population Description"') && !is(study, ++i, '"Sampling Method"'))
finalRecord['StudyPopulationDesc'] = cleanLine(study, i++);

if (is(study, i, '"Sampling Method"') && !is(study, ++i, '"Condition(s)/Problem(s)"'))
finalRecord['SamplingMethod'] = cleanLine(study, i++);
