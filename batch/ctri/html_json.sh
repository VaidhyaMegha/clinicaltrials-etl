...
"secondary_sponsor":{"Name":.[14].children[0].children[0].children[1].children[0].text,"Address":.[14].children[0].children[0].children[1].children[1].text},
 ...
 "ethics_committee":.[17].children[0].children[0].children[2:] | [[{"Name of Committee":.[].children[0].text}], [{"Approval Status ": .[].children[1].text}]] |  transpose|map(add),
 "regulatory_clearance_status":.[18].children[0].children[0].children[1].children[0].text,
 "condition_or_problems":"",
 "intervention_or_comparator_agent":"",
 "inclusion_criteria":"",
 "exclusion_criteria":"",
