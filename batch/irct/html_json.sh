...
if [[ ${download} == 'yes' ]]; then
    ...
    NUM_OF_PAGES=`cat ${html_dir}/*.html | grep -Eo '<a href="/search/*[^>]*>' |grep -oE '[0-9]*' | sort -g | tail -n 1`
